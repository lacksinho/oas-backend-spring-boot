...
public interface ApplicantRepository extends JpaRepository<Applicant, Long> {
    ...
    Applicant getApplicantByFormFourIndex(String indexNumber);
    ...
    Page<Applicant> findByIsSubmittedAndFirstNameContainingIgnoreCaseOrIsSubmittedAndLastNameContainingIgnoreCaseOrIsSubmittedAndFormFourIndexContainingIgnoreCase(
            Boolean submitted1, String firstName,
            Boolean submitted2, String lastName,
            Boolean submitted3, String indexNumber,
            Pageable pageable
    );
